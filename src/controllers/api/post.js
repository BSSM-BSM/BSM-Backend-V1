...
const view = async (req, res) =>{
    ...
    result = await model.view(jwtValue.memberCode, jwtValue.memberLevel, boardType, likeBoardType, req.params.postNo, isAnonymous)
...
const write = async (req, res) =>{
    ...
    result = await model.write(jwtValue.memberCode, jwtValue.memberNickname, boardType, xss.process(req.body.postTitle), xss.process(req.body.postContent))
    res.send(JSON.stringify(result))
}
const update = async (req, res) =>{
    ...
    result = await model.update(jwtValue.memberCode, jwtValue.memberLevel, boardType, req.params.postNo, xss.process(req.body.postTitle), xss.process(req.body.postContent))
    res.send(JSON.stringify(result))
}
const del = async (req, res) =>{
    ...
    result = await model.del(jwtValue.memberCode, jwtValue.memberLevel, boardType, req.params.postNo)
    res.send(JSON.stringify(result))
}
